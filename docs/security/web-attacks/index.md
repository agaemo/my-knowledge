...
- [ヌルバイト汚染](/security/web-attacks/null-byte) — ヌルバイトで言語間の文字列終端のずれを突き、検証を回避する
- [Content-Type ヘッダー操作](/security/web-attacks/content-type) — クライアントが自由に書き換えられるヘッダーを信頼することで生じる脆弱性
