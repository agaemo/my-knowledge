...
::: tip プロンプトエンジニアリングを先に試す
Fine-tuning はコストと時間がかかる。まずプロンプトエンジニアリングで解決できないか徹底的に試す。
:::
...
::: tip 品質 > 数量
ノイズの多い大量データより、高品質な少量データの方が効果が高い。
:::
...
::: warning 汎用能力の低下に注意
特定タスクに特化しすぎると、元モデルの汎用能力が低下することがある。Fine-tuning 前後で元モデルの能力も Evals に含めて確認する。
:::
